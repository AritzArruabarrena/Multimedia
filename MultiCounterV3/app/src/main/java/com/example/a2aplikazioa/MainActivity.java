...
public class MainActivity extends AppCompatActivity {
   ...
   int gehiketaGenerala;
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        //valoriak gordetzen ditu bundlen
        outState.putInt("gehiketaGenerala", gehiketaGenerala);
        outState.putInt("lehenengoGehiketa", lehenengoGehiketa);
        outState.putInt("bigarrenGehiketa", bigarrenGehiketa);
        outState.putInt("hirugarrenGehiketa", hirugarrenGehiketa);
        outState.putInt("laugarrenGehiketa", laugarrenGehiketa);
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        //Valoreak berriz restauratu eginten ditu bundleletik
        gehiketaGenerala = savedInstanceState.getInt("gehiketaGenerala");
        lehenengoGehiketa = savedInstanceState.getInt("lehenengoGehiketa");
        bigarrenGehiketa = savedInstanceState.getInt("bigarrenGehiketa");
        hirugarrenGehiketa = savedInstanceState.getInt("hirugarrenGehiketa");
        laugarrenGehiketa = savedInstanceState.getInt("laugarrenGehiketa");
        //Kontagailuetan datuak ipintzen ditu(actualizatu)
        KontagailuOrokorra.setText(String.valueOf(gehiketaGenerala));
        KontagailuBat.setText(String.valueOf(lehenengoGehiketa));
        KontagailuBi.setText(String.valueOf(bigarrenGehiketa));
        KontagailuHiru.setText(String.valueOf(hirugarrenGehiketa));
        KontagailuLau.setText(String.valueOf(laugarrenGehiketa));
    }
}